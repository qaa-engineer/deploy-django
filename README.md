...
3. Устанавливаем и конфигурируем последний PostgreSQL. Делается под рутом.
...
группу sudo.
	...
	Повторим пункт 2 для пользователя django - допишем в конфигурацию алиасы и патчи, чтобы вызывался последний Python 
