...
7. Тестирование способности Gunicorn обслуживать проект
...
8. Устанавливаем и конфигурируем последний PostgreSQL.
	...
	Для примера, вот так выглядят мои настройки БД в проекте:
